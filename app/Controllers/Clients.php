...
class Clients extends Security_Controller {
    ...
    private function _make_row($data, $custom_fields) {
        ...
        $row_data = array($data->id,
            ...
            to_currency($data->wallet_balance, $data->currency_symbol),
        ...
        $row_data[] = modal_anchor(get_uri("clients/modal_form"), "<i data-feather='edit' class='icon-16'></i>", array("class" => "edit", "title" => app_lang('edit_client'), "data-post-id" => $data->id)).modal_anchor(get_uri("clients/modal_form"), "<i data-feather='edit' class='icon-16'></i>", array("class" => "edit", "title" => app_lang('edit_client'), "data-post-id" => $data->id))
